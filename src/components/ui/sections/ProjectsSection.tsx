...
export const ProjectsSection = () => {
  ...
  return (
    ...
    >
      {/* Decorative glow */}
      <div className="absolute top-40 left-20 w-96 h-96 rounded-full opacity-15 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(191, 91, 61,0.38) 0%, rgba(191, 91, 61,0) 72%)' }} />
