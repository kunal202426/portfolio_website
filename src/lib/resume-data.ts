  ...
  projects: [
    {
      ...
      year: '2026',
      period: '2026',
      description: 'Predicts stock prices by combining LSTM, LightGBM, and FinBERT sentiment analysis on live news - all packaged into a real-time web app.',
    ...
    },
    {
      ...
      year: '2026',
      period: '2026',
      description: 'A city traffic simulator with live dashboards - dial in fleet size, surge pricing, and weather, then watch demand and congestion respond in real time.',
    ...
    },
    {
      ...
      year: '2026',
      period: '2026 - Present',
      description: 'A real-time gaze tracker built with deep learning - uses Kalman filtering and a temporal ensemble to stay stable without constant retraining.',
    ...
    },
    {
      ...
      year: '2025',
      period: '2025 - Present',
      description: 'AI agents that hire each other - tasks run off-chain while a smart contract holds payment in escrow and releases it only when the job is verified on-chain.',
    ...
    },
    {
      ...
      year: '2025',
      period: '2025',
      description: 'Self-hosted job hunting tool - scrapes LinkedIn listings, drafts personalized cold emails with AI, and ships with a Chrome extension so you can pull jobs in one click.',
    ...
    },
    {
      ...
      year: '2025',
      period: '2025',
      description: 'A blockchain app that puts fertilizer subsidies on-chain - farmers redeem through MetaMask, the smart contract handles allocation, and every transaction leaves an audit trail.',
    ...
    },
    {
      ...
      year: '2024',
      period: '2024',
      description: 'The official website for Team Levitate Hyperloop - fully 3D, responsive, and built with Three.js and React to match the energy of a competition-grade engineering team.',
