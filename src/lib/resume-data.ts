export const resumeData = {
  ...
  projects: [
    ...
    },
    {
      ...
      year: '2026',
      period: '2026',
      description: 'An autonomous AI agent that detects performance degradation in neural networks and self-heals through dynamic hyperparameter tuning, architecture mutation, and real-time recovery strategies — no human intervention required.',
    ...
    },
    {
      ...
      year: '2026',
      period: '2026 - Present',
      description: 'A semantic, AI-native repository intelligence platform that serves as the memory layer for AI coding agents, engineering teams, and autonomous engineering workflows.',
