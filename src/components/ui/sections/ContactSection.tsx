    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="laptop-container flex justify-center items-center" style={{ perspective: '2000px', perspectiveOrigin: '50% 50%' }}>
          <motion.div
            className="relative"
            style={{
              width: '500px',
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center gap-20 p-16">
                {/* GitHub Icon */}
                <motion.a
                ...
                >
                  <div 
                    className="w-32 h-32 rounded-3xl flex items-center justify-center transition-all duration-300"
                    style={{
                      background: isDark 
                  ...
                  >
                    <svg width="56" height="56" viewBox="0 0 24 24" fill="#F5F0E8">
            ...
            >
              {/* Keyboard Keys Grid */}
              <div className="p-6 grid grid-cols-12 gap-1.5">
                {/* Row 1 - Function keys */}
                {[...Array(12)].map((_, i) => (
                  <div 
                    key={`fkey-${i}`}
              ...
              {/* Trackpad */}
              <div 
                className="absolute bottom-4 left-1/2 transform -translate-x-1/2 rounded-lg"
                style={{
                  width: '120px',
                  height: '40px',
