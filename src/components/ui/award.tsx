    ...
    return (
      ...
      >
        ...
        style={{
          ...
          <h1
            className={cn(
              "mt-4 grid text-3xl leading-7 font-bold tracking-tighter uppercase text-gray-900"
            )}
          >
            Certificate
            <span className="text-sm font-light tracking-tight text-gray-700">
              {" "}
              of {title}
            </span>
          </h1>

          <p className="text-gray-600 mt-4 mb-1 text-xs">
            This is to certify that
          </p>
          <h1
            className={cn(
              "text-[var(--accent-primary)] mb-2 border-b text-xl font-semibold tracking-tight border-[var(--accent-primary)]"
            )}
          >
            {recipient}
          </h1>
          ...
          <div className="mt-6 flex justify-center">
            <Award strokeWidth={1} className="h-4 w-4 text-[var(--accent-primary)]" />
          </div>
