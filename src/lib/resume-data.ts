export const resumeData = {
  ...
  projects: [
    ...
    {
      title: 'Levitate Hyperloop Control Panel',
      subtitle: 'Embedded Systems & Network Simulation',
      year: '2026',
      period: '2026',
      description: 'A live, fully configurable operations control center for a simulated hyperloop pod network - real-time 3D corridor visualization, a genuine pod state-machine simulation engine, and an operator console for every system constraint.',
      tags: ['Next.js', 'TypeScript', 'React Three Fiber', 'Three.js', 'Tailwind CSS', 'Recharts'],
      color: '#3B82F6',
      featured: true,
      starred: true,
      category: 'dev',
      ...
      achievements: [
        ...
        'Rendered the corridor two ways - a 3D tube with elevated pylons and a chase camera, and a 2D schematic map - both generated procedurally from live configuration.',
        'Shipped 10 operations pages: Operations Center, Route Map, Tube Systems, Infrastructure, Terrain, Analytics, Pod Schedule, Weather, Alerts, and Operations Log.',
      ],
    },
    {
  ...
  skills: {
    languages: ['Java', 'Python', 'JavaScript (ES6+)', 'Solidity', 'TypeScript', 'SQL'],
    frontend: [
      { name: 'React.js', level: 95 },
      { name: 'Next.js', level: 84 },
      { name: 'Redux', level: 82 },
      { name: 'Three.js', level: 85 },
      { name: 'React Flow', level: 82 },
      { name: 'HTML5', level: 98 },
      { name: 'CSS3', level: 93 },
    ...
    concepts: ['Distributed Systems', 'Chaos Engineering', 'CI/CD', 'Agile/Scrum', 'SDLC', 'OOP', 'Data Structures & Algorithms'],
  },
  achievements: [
    {
