          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className="rounded-3xl flex items-center justify-center transition-all duration-300 relative overflow-hidden"
                    style={{
                  ...
                  >
                    <motion.div
                      className="absolute inset-0 pointer-events-none"
                      style={{ background: 'linear-gradient(110deg, transparent 25%, rgba(255,255,255,0.13) 50%, transparent 75%)', zIndex: 1 }}
                      animate={{ x: ['-140%', '140%'] }}
                      transition={{ duration: 2.2, repeat: Infinity, repeatDelay: 2.5, ease: 'easeInOut' }}
                    />
                    <svg width={laptopSize.iconSize * 1.75} height={laptopSize.iconSize * 1.75} viewBox="0 0 24 24" fill="#F5F0E8" style={{ position: 'relative', zIndex: 2 }}>
                ...
                >
                  ...
                  >
                    <motion.div
                      className="absolute inset-0 pointer-events-none"
                      style={{ background: 'linear-gradient(110deg, transparent 25%, rgba(255,255,255,0.22) 50%, transparent 75%)', zIndex: 1 }}
                      animate={{ x: ['-140%', '140%'] }}
                      transition={{ duration: 2.2, repeat: Infinity, repeatDelay: 1.8, ease: 'easeInOut', delay: 1.2 }}
                    />
                    <svg width={laptopSize.iconSize * 1.75} height={laptopSize.iconSize * 1.75} viewBox="0 0 24 24" fill="#F5F0E8" style={{ position: 'relative', zIndex: 2 }}>
